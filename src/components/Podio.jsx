  ...
  return (
    <div className="relative w-full max-w-lg mx-auto flex flex-col items-center gap-6">
      ...
      {/* Foco giratorio detrás del podio (rayos de luz del ganador).
          ...
          NO lleva contenedor con overflow-hidden: recortaba los rayos en
          notebook/PC (donde GAMA_BAJA es false) y el festejo se veía distinto.
          El desborde horizontal no ocurre: el HTML global tiene
          `overflow-x: clip` y el foco (416-544 px) solo se renderiza en
          pantallas > 480 px, donde entra completo. */}
      {!GAMA_BAJA && (
