...
| V5 | **INFO** | `trivia_responder` leído fuera de lock puede validar contra una pregunta que el host acaba de rotar. Ventana mínima (1 host, guard de UI). | Residual aceptado; documentado. |
